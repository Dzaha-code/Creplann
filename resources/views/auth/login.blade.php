...
<head>
    ...
    <title>{{ config('app.name', 'CrePlann') }} — Masuk</title>
...
<body class="auth-page">
    ...
    <div class="auth-card">
        ...
        <p class="lede">Masuk untuk melanjutkan rencana pekanmu.</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-footer">
                @if (Route::has('password.request'))
                    <a class="link-muted" href="{{ route('password.request') }}">Lupa kata sandi?</a>
                @else
                    <span></span>
                @endif
        ...
        <p class="switch-line">
            Belum punya akun?
            <a href="{{ route('register') }}" class="link-muted">Daftar gratis</a>
        </p>
    </div>
